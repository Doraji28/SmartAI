...
function grid_renderer.draw_boss_icon(stage_idx, cx, cy, boss_scale, time)
    ...
    elseif stage_idx == 3 then
        base_color = {0.15, 0.9, 0.4, 0.95} -- Green
    elseif stage_idx == 4 then
        base_color = {0.75, 0.15, 0.9, 0.95} -- Purple
    elseif stage_idx == 5 then
        base_color = {0.95, 0.55, 0.15, 0.95} -- Orange
    elseif stage_idx == 6 then
        base_color = {0.95, 0.85, 0.15, 0.95} -- Yellow
    elseif stage_idx == 7 then
        base_color = {0.95, 0.15, 0.75, 0.95} -- Magenta/Pink
    end
    
    local glow_color = {1.0, 0.9, 0.2, 1.0}
    
    draw_abstract_boss_core(time, boss_scale, stage_idx, base_color, glow_color, false, false, 2)
